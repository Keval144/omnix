...
export const projects = pgTable(
  ...
  (table) => [
    ...
    index("ix_projects_user_id").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const datasets = pgTable(
  ...
  (table) => [
    index("ix_datasets_project_id").using(
      "btree",
      table.projectId.asc().nullsLast().op("uuid_ops"),
    ),
    index("ix_datasets_uploaded_at").using(
      "btree",
...
export const notebooks = pgTable(
  ...
  (table) => [
    index("ix_notebooks_created_at").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamptz_ops"),
    ),
    index("ix_notebooks_project_id").using(
      "btree",
      table.projectId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const chatSessions = pgTable(
  ...
  (table) => [
    index("ix_chat_sessions_created_at").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamptz_ops"),
    ),
    index("ix_chat_sessions_project_id").using(
      "btree",
      table.projectId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const chatMessages = pgTable(
  ...
  (table) => [
    index("ix_chat_messages_created_at").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamptz_ops"),
    ),
    index("ix_chat_messages_session_id").using(
      "btree",
