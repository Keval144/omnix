...
export default function SignInPage() {
  ...
  const handleLogin = async () => {
    ...
    const toastId = toast.loading("Signing you in…", {
      description: "Hang tight, authenticating your account.",
    });
  ...
  return (
    ...
    >
      ...
      {/* ── PRIMARY glow — bottom-left, hot and tight ── */}
      <div
        aria-hidden
      ...
      {/* ── SECONDARY glow — top-right, dimmer and wide ── */}
      <div
        aria-hidden
        className="pointer-events-none absolute z-10"
        style={{
      ...
      {/* Card — above the glow so glow leaks around edges */}
      <div
        ...
        <div className="px-8 pt-8 pb-8 flex flex-col gap-6">
          ...
          <div className="text-center">
            ...
            <p className="mt-1.5 text-sm" style={{ color: "rgba(180,200,185,0.6)" }}>
              Sign in to continue building with data
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="signin-email" className="text-xs font-medium" style={{ color: "rgba(160,185,168,0.7)" }}>
                Email
              </Label>
            ...
            {/* Password */}
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="signin-password" className="text-xs font-medium" style={{ color: "rgba(160,185,168,0.7)" }}>
                Password
              </Label>
              <div className="relative">
          ...
          <p className="text-center text-xs" style={{ color: "rgba(100,140,112,0.6)" }}>
            ...
            <Link href="/sign-up" className="font-semibold hover:brightness-125 transition-all" style={{ color: "#4ade80" }}>
              Sign up
            </Link>
          </p>
        </div>
